...
def single_main(rank, world_size, args):
    ...
    train_loader, valid_loader = get_loader(args, tokenizer, TrainSet, ValidSet, rank)
    ...
    runner = SingleRunner(model, tokenizer, train_loader, valid_loader, device, args, rank)
...
if __name__ == "__main__":
    ...
    if init_args.distributed and ngpus_per_node > 1:
        ...
        single_main(0, ngpus_per_node, init_args)